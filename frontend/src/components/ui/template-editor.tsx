...
export const TemplateEditor = forwardRef<TemplateEditorRef, TemplateEditorProps>(function TemplateEditor({
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      <div
        ref={sizerRef}
        className="invisible absolute left-0 right-0 p-2 pr-4 text-sm whitespace-pre-wrap break-words border border-transparent"
        style={{ minHeight }}
        aria-hidden="true"
      >
        {displayContent}
      ...
      <div
        ref={highlightRef}
        className={cn(
          'absolute inset-0 p-2 pr-4 text-sm whitespace-pre-wrap break-words overflow-hidden pointer-events-none',
      ...
      <textarea
        ...
        disabled={disabled}
        className={cn(
          'relative w-full p-2 pr-4 text-sm whitespace-pre-wrap break-words resize-none overflow-auto',
