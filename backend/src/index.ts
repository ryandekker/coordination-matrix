...
// Load build info once at startup (generated by deploy scripts)
const buildInfoPath = join(backendDir, 'build-info.json');
const buildInfo = existsSync(buildInfoPath)
  ? JSON.parse(readFileSync(buildInfoPath, 'utf-8'))
  : null;

// Health check — public, no auth, reachable at cm.hcizero.com/api/health
