...
import { workflowFoldersRouter } from './routes/workflow-folders.js';
...
app.use('/api/workflow-folders', requireAuth, requireScope(SCOPES.WORKFLOWS_READ), workflowFoldersRouter);
