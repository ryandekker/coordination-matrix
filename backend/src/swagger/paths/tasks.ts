  ...
  '/api/tasks': {
    get: {
      ...
      parameters: [
        ...
        { name: 'workflowId', in: 'query', schema: { type: 'string' }, description: 'Filter by workflow definition ID' },
        { name: 'workflowRunId', in: 'query', schema: { type: 'string' }, description: 'Filter by workflow run ID' },
        { name: 'workflowStage', in: 'query', schema: { type: 'string' }, description: 'Filter by workflow stage name' },
        { name: 'hasWorkflow', in: 'query', schema: { type: 'boolean' }, description: 'Filter tasks that are part of a workflow (true) or standalone (false)' },
